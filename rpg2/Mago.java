...
public class Mago extends Personagem {
    public Mago() {
        super("Mago", 70, 50, 100, 40);
    }

    
    public void realizarTeste(String atributo) {
        if (atributo.equalsIgnoreCase("inteligencia")) {
            rolagemDados.rolarComVantagem();
        } else if (atributo.equalsIgnoreCase("forca") || atributo.equalsIgnoreCase("destreza")) {
            rolagemDados.rolarComDesvantagem();
        } else {
